...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CONSTRUCTION DES CENTRES DE CONTRÔLE TECHNIQUE DES VEHICULES</h5>
        <p>INDUSTRIE</p>
        <p class="card-text">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p>INDUSTRIE</p>
        <p class="card-text">
          Le marché nigérien de ciment connaît depuis 2000 une croissance annuelle moyenne de + 10% et sa production nationale ne couvre que 20%. Le Niger qui dispose d’une faible capacité de production de…
        </p>
