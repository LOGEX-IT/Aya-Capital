...
<!--           <span>WHAT WE DO</span>
 -->          <h3> FORMATIONS ET COACHING</h3>
          <ol class="breadcrumb">
            <li>
              <a href="#"><i class="fa fa-home"></i> ACCUEIL </a>
            </li>
            <li>
              <a href="#"> Formations et coaching    </a>
            </li>
...
<div class="row">
                    <div class="col-md-6 col-sm-6">
                      <div class="item-team">
                        ...
                        <div class="body-team">
                          <p style="font-size: 14px; text-align: justify; padding: 15px;"> Les programmes de nos formations peuvent être aussi personnalisés, adaptés aux besoins de nos clients grâce à la mise en place d’une méthodologie d’évaluation des besoins et du niveau des connaissances au début des formations.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                      <div class="item-team">
                        ...
                        <div class="body-team">
                          <p style="font-size: 14px; text-align: justify; padding: 15px;">Notre offre de formation orientée vers le développement de compétences intègre déjà plusieurs modules sur des thèmes relatifs à la Finance et à la stratégie, et ce grâce à notre large catalogue de formation et à notre réseau de Formateurs Partenaires.</p>
                        </div>
