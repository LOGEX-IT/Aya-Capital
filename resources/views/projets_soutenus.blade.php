...
<div class="row">
                    <div class="col-md-6 col-sm-6">
                      <div class="item-team">
                        <img src="{{URL::to('public/template/images/projetsoutenu1.jpg')}}" class="img-responsive" style="height: 250px;" alt="Image">
                        <div class="body-team">
                          <h3> SAMA Money</h3>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                      <div class="item-team">
                        <img src="{{URL::to('public/template/images/projetsoutenu2.jpg')}}" class="img-responsive" style="height: 250px;" alt="Image">
                        <div class="body-team">
                          <h3>Programme immobilier en Guinée</h3>
                        </div>
