...
<!--           <span>WHAT WE DO</span>
 -->          <h3> PROJETS D'INVESTISSEMENT DU NIGER<br>EN MINE</h3>
          <!-- <ol class="breadcrumb">
            <li>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION CIMENTERIE A KAO</h5>
        <p>MINES</p>
        <p class="card-text">
         L’objectif visé par le projet est la construction d’une usine de production de ciment d’une capacité de 950 000 tonnes de ciment par an dans un domaine privé de l’Etat d’environ 7154 hectares dans…
        </p>
        <a href="{{URL::to('/investissement-en-mine/creation-cimenterie-kao')}}" class="btn btn-default">VOIR PLUS</a>
      </div>
    </div>
  </div>
</div>
