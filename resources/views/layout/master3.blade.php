...
<html lang="en">
 ...
 <meta name="google-site-verification" content="PtoyWHPCadfLcA0I_ddGexmW8xwbb0dWGk3YdaIkKJM" />
    
    <meta name="description" content="Fondé sur des valeurs d’expertise, d’écoute et d’exigence, AYA Capital est un cabinet conseil, indépendant, avec une expertise multisectorielle sur les marchés financiers. Nous accompagnons les dirigeants et actionnaires d’entreprises dans leurs opérations de financement et dossiers de fusion-acquisition, avec pour seuls objectifs : négocier au mieux les intérêts de nos clients et multiplier leurs chances de réussite dans leurs opérations de haut bilan. Une activité qui s’équilibre autour des opérations de financement et des dossiers de fusion-acquisition."> 
    <meta name="keywords" content="aya-capital ayc capital financement investisseur projet aya-capital.com">

    <!--Security-->
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' https: wss://vsa6.tawk.to/* 'unsafe-inline' 'unsafe-eval'">
    <meta http-equiv="Expect-CT" content="enforce, max-age:30">
    <meta http-equiv="Referrer-Policy" content="same-origin">
    <meta http-equiv="Strict-Transport-Security" content="max-age:3">
    ...
    <!--OGP-->
    <meta property="og:title" content="aya-capital" />
    <meta property="og:url" content="https://www.aya-capital.com" /> 
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="aya-capital" />
    <meta property="og:locale" content="fr_FR" />
    <meta property="og:description" content=" Cabinet indépendant de conseil en ingénierie financière et levée de fonds, cession d’entreprise et réorganisation de capital" />
    <meta property="og:image" content="https://www.aya-capital.com/template/images/ayalogo.png" />

    <!--End OGP-->

    <!--Twitter Card-->
    <meta property="twitter:title" content="aya-capital" />
    <meta property="twitter:url" content=" https://www.aya-capital.com" />
    <meta property="twitter:card" content="aya-capital vous aide dans la reherche d'un investissement ou d'un projet dans lequel investir." />
    <meta property="twitter:description" content=" Fondé sur des valeurs d’expertise, d’écoute et d’exigence, AYA Capital est un cabinet conseil, indépendant, avec une expertise multisectorielle sur les marchés financiers. Nous accompagnons les dirigeants et actionnaires d’entreprises dans leurs opérations de financement et dossiers de fusion-acquisition, avec pour seuls objectifs : négocier au mieux les intérêts de nos clients et multiplier leurs chances de réussite dans leurs opérations de haut bilan. Une activité qui s’équilibre autour des opérations de financement et des dossiers de fusion-acquisition." />
    <meta property="twitter:image" content="https://www.aya-capital.com/template/images/ayalogo.png" />
        ...
        <ul style="background-color: green;">
          ...
          <li><a href="#">A propos</a>
            <ul style="background-color: green;">
              ...
              <li><a href="{{URL::to('apropos')}}" ><span>A propos de nous</span></a>
                <li><a href="{{URL::to('/equipe')}}" ><span>Notre équipe</span></a>
               <!--  <ul >
              ...
              <li><a href="#" ><span>Références et Partenaires</span></a>
              </li>
              <li><a href="{{URL::to('/contact')}}" ><span>Nous joindre</span></a>
              </li>
            </ul>
          </li>
          <li>
            <a href="#">Services </a>
             ...
             <ul style="background-color: green;">
              ...
              <li><a href="#" ><span>Structuration et levée de fonds</span></a>
                <ul style="background-color: green;">
              ...
              <li><a href="{{URL::to('strategie')}}" ><span>Stratégie</span></a>
              </li>
              <li><a href="{{URL::to('/contact')}}" ><span>Cession et Acquisitions</span></a>
                <ul style="background-color: green;">
                  <li><a href="{{URL::to('acquisition')}}" ><span>Acquisition</span></a></li>
                  <li><a href="{{URL::to('cession')}}" ><span>Cession</span></a></li>
                </ul>
              </li>
              <li><a href="{{URL::to('service-corpatif')}}" ><span>Services corporatifs</span></a>
              </li>
            </ul>
            
          </li>
          <li>
            <a href="#">Fonds d'investissement</a>
          ...
          <ul style="background-color: green;">
              ...
              <li><a href="#" ><span>AYA FUND</span></a>
                <ul style="background-color: green;">
                  ...
                  <li><a href="{{URL::to('fonctionnement')}}" ><span>Fonctionnement</span></a></li>
                  <li><a href="{{URL::to('nos-donateurs')}}" ><span>Donnateurs</span></a></li>
                  <li><a href="{{URL::to('projets-soutenus')}}" ><span>Projets soutenus</span></a></li>
                </ul>
              </li>

              <li><a href="{{URL::to('aya-impact')}}" ><span>Impact</span></a>
              </li>
              <li><a href="{{URL::to('gouvernance')}}" ><span>Gouvernance</span></a>
              </li>
              <li><a href="{{URL::to('nos-donateurs')}}" ><span>Devenir donnateur</span></a>
              </li>
              <li><a href="{{URL::to('administration-de-fonds')}}" ><span>Administration de Fonds</span></a>
              </li>
            </ul>
            
          </li>
           <li>
            <a href="{{URL::to('/investir/1')}}">Investir </a>
          </li>
          <li>
            <a href="{{URL::to('formation-et-coaching')}}">Formations et Coaching </a>
          </li>
          <li>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="tb-contact tb-iconbox">
                  <ul>
                    <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><span><i><b>AYA CAPITAL</b></i> <b>Bamako, Qtier Baco Djicoroni ACI Près de INTEC, Mali</b></span></a></li>
                ...
                <div class="tb-social-lan language">
                  <select id="dynamic_select" onchange="myFunction()"  class="lang" >
                      <option  data-class="fr" value="https://aya-capital.com/">Francais</option>
                      <option data-class="usa" value="https://aya-capital.com/en">Anglais</option>
                    </select>
                  <ul>
              ...
              <div class="col-md-12">
                ...
                <nav>
                  <ul class="navi-level-1 active-subcolor">
                    ...
                    <li><a href="{{URL::to('apropos')}}">A propos</a>
                      <ul class="navi-level-2">
                        <li><a href="{{URL::to('apropos')}}" ><span>A propos de nous</span></a>
                        </li>
                        <li><a href="#" ><span>Références et Partenaires</span></a>
                        </li>
                        <li><a href="#" ><span>Notre équipe</span></a>
                        </li>
                        <li><a href="{{URL::to('contact')}}" ><span>Nous joindre</span></a>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul class="navi-level-2">
                        <li ><a  href="#">Structuration et levée de fonds </a>
                        ...
                        <li ><a  href="{{URL::to('apropos')}}">Cession et Acquisitions </a>
                          <ul class="navi-level-3">
                            <li><a href="{{URL::to('acquisition')}}" ><span>Acquisition</span></a></li>
                            <li><a href="{{URL::to('cession')}}" ><span>Cession</span></a></li>
                          </ul>
...
<!--                         <li ><a  href="#">Investir </a></li>
 -->                      </ul>
                    ...
                    <li>
                      ...
                      <ul class="navi-level-2">
                        ...
                        <li><a href="{{URL::to('gouvernance')}}">Gouvernance</a>
                        </li>
                        <li><a href="{{URL::to('nos-donateurs')}}">Devenir donnateur</a>
                        </li>
                        <li><a href="{{URL::to('administration-de-fonds')}}" ><span>Administration de Fonds</span></a></li>
                      </ul>
                    </li>
                    <li>
                      <a href="{{URL::to('/investir/1')}}">Investir</a>
                    ...
                    <li class="@yield('contactive')"><a  href="{{URL::to('/contact')}}">Contact</a>
                    </li>
                  </ul>
                </nav>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="widget widget-footer widget-footer-icon-link">
                ...
                <ul class="icon-link-list-icon">
                  <li><i class="fa fa-map-marker" aria-hidden="true"></i>AYA CAPITAL<br>Bamako, Qtier Baco Djicoroni ACI Près de INTEC, Mali</li>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="widget widget-footer widget-footer-hours">
                ...
                <p>Veuillez nous contacter pour toute demande.</p>
                <dl class="dl-horizontal dl-working-hours">
                  <dt>Lundi - Vendredi  </dt>
                  <dd>8 H 00 - 17 H 00</dd>
                </dl>
              </div>
            </div>
            <div class="col-md-3 col-sm-6">
              <div class="widget widget-footer widget-footer-list-news">
                ...
                <ul class="footer-list-news">
                  <li>
                    ...
                    <a href="#"></a>
                    <small class="time">02 Juin 2021</small>
                  </li>
                  <li>
                    <a href="#"><img src="{{asset('public/template/images/ayalogo.jpeg')}}" width="70" class="img-responsive" alt="Image"></a>
                    <a href="#"></a>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="widget widget-footer widget-footer-subcri">
                ...
                <p>Abonnez-vous à notre newsletter pour les dernières mises à jour sur notre entreprise</p>
                <form class="form-subcri-footer">
                  <div class="form-group">
                    <input type="email" class="form-control"   placeholder="Email Address">
                  </div>
                  <button type="submit" class="btn-subcri-footer">Soumettre</button>
                </form>
              </div>
            </div>
          </div>
 ...
 -->                    <p>Développé par <span>LOGEX</span></p>
                  </ul>
                </div>
                <div class="copyright-text">
                  <p>Copyright © 2021 <span>AYA CAPITAL</span> Tous Droits Réservés</p>
                </div>
              </div>
            </div>
          </div>
...
<!--     <script src="{{asset('public/template/js/plugins/jquery.counterup.min.js')}}"></script>
    ...
    <script src="{{asset('public/template/js/plugins/contact.js')}}"></script>  -->
    <!-- Global Js
