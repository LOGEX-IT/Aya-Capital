...
<!--           <span>WHAT WE DO</span>
 -->          <h3> PROJETS D'INVESTISSEMENT DU NIGER<br>EN ELEVAGE</h3>
          <!-- <ol class="breadcrumb">
            <li>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">PRODUTION INTENSIVE DE POISSON</h5>
        <p>ELEVAGE</p>
        <p class="card-text">
         Le Niger procède un vaste réseau hydrique composé principalement par le fleuve Niger, le lac Tchad, la komadougou Yobé ainsi que d’innombrable mares permanentes et semi-permanentes.
        </p>
        <a href="{{URL::to('/projets-investissement-elevage1/prodution-intensive-de-poisson')}}" class="btn btn-default">VOIR PLUS</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION D’UN ABATTOIR MODERNE A NIAMEY</h5>
        <p>ELEVAGE</p>
        <p class="card-text">
         Le but de ce projet est de créer un abattoir moderne d’une grande capacité d’abattage pour répondre efficacement à la demande croissante en viande sur les marchés de Niamey des villes…
        </p>
        <a href="{{URL::to('/projets-investissement-elevage2/creation-dun-abattoir-moderne-niamey')}}" class="btn btn-default">VOIR PLUS</a>
      </div>
    </div>
  </div>
</div>
