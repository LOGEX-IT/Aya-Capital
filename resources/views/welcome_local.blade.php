          ...
          <div id="slider_2" class="rev_slider fullwidthabanner slider-home2" style="display:none;" data-version="5.0.7">
            <ul>
              ...
              <li data-title="FOCUS ON">
                <!-- MAIN IMAGE -->
                <img src="{{URL::to('/template/images/Slider/home2/3.jpg')}}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 0 -->
                <div class="tp-caption tp-resizeme " 
                  ...
                  ><img src="{{URL::to('/template/images/Slider/home2/3.jpg')}}" class="img-responsive hidden-sm hidden-xs" alt="Image">
                </div>
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme sl-s4" 
                  ...
                  data-responsive_offset="on" 
                  >
<!--                   <p >RESTEZ EN SÉCURITÉ AVEC AYA CAPITAL</p>
 -->                </div>
                <!-- LAYER NR. 2 -->
                ...
                <div class="tp-caption tp-resizeme sl-s3" 
                  ...
                  data-responsive_offset="on" 
                  >
                  <p>Cabinet indépendant de conseil en ingénierie financière et levée de fonds, cession d’entreprise et réorganisation de capital.</p>
                </div>
                ...
                <div class="tp-caption" 
                  ...
                  data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;"
                  data-start="2100" 
                  ><a href="#" class="sl-btn-1">Nous écrire</a>
                </div>
              </li>
              <!-- SLIDE  -->
              <li data-title="FOCUS ON">
                <!-- MAIN IMAGE -->
                <img src="{{URL::to('/template/images/Slider/home2/2.jpg')}}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 0 -->
                <div class="tp-caption tp-resizeme " 
                   data-x="left" data-hoffset="" 
                  ...
                  data-start="1000" 
                  data-responsive_offset="on" 
                  ><img src="{{URL::to('/template/images/Slider/home2/2.jpg')}}" class="img-responsive hidden-sm hidden-xs" alt="Image">
                </div>
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme sl-s4" 
                   data-x="['center','left','left','left']" data-hoffset="['290','0','0','0']"
...
<!--                   <p style="font-size: 25px;">RESTEZ EN SÉCURITÉ AVEC AYA CAPITAL</p>
 -->                </div>
                ...
                <div class="tp-caption tp-resizeme sl-s2" 
                  ...
                  data-fontsize="['60','50','40','30']" 
                  data-responsive_offset="on" 
                  ><p style="font-size: 30px;">RESTEZ EN SÉCURITÉ AVEC AYA CAPITAL</p>
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme sl-s3" 
                  data-x="['center','left','left','left']" data-hoffset="['290','0','0','0']"
              ...
              <li data-title="FOCUS ON">
                <!-- MAIN IMAGE -->
                <img src="{{URL::to('/template/images/Slider/home2/1.jpg')}}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 0 -->
                <div class="tp-caption tp-resizeme " 
                   data-x="left" data-hoffset="" 
                  ...
                  data-start="1000" 
                  data-responsive_offset="on" 
                  ><img src="{{URL::to('/template/images/Slider/home2/1.jpg')}}" class="img-responsive hidden-sm hidden-xs" alt="Image">
                </div>
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme sl-s4" 
                   data-x="['center','left','left','left']" data-hoffset="['290','0','0','0']"
 ...
 -->                </div>
      ...
      <section class="bg-quote-h2">
        <div class="quote-inner quote-inner-h2">
          <p>Pour des conseils financiers d'experts, vous pouvez faire confiance à <span> AYA CAPITAL</span></p>
          <a href="{{URL::to('/contact')}}" class="ot-btn btn-sub-color">Nous contacter</a>
        </div>
      </section>
      <!-- /Quote -->
            ...
            <div class="whyus-warp-h2">
              <div class="col-md-6">
                ...
                <div class="demo-style-1-warp">
                  <img src="{{URL::to('/template/images/Content/demo-style-1.jpg')}}" class="img-responsive" alt="Image">
              ...
              <div class="col-md-6">
                ...
                <div class="iconbox-warp ">
                  <h3 class="title-mix"><strong> Que demain commence aujourd'hui</strong></h3>
                  ...
                  <div class="iconbox">
                   <span class="icon icon-library"></span>
                    <h4>Conseil en réorganisation et transmission de capital</h4>
                   <p>
                  ...
                  <div class="iconbox">
                    <span class="icon icon-library"></span>
                    <h4>Levée de Fonds</h4>
                    <p>
                      Accompagnement et conseils en levées de fonds.
                    </p>
                    <p>
                  ...
                  <div class="iconbox">
                    ...
                    <h4>Cession d'entreprise</h4>
                    <p>
                      Accompagnement et conseil en cession d’entreprise
                    </p>
                    <p>
                      dentification des acquéreurs (personnes morales ou physiques).
                    </p>
                    <p>
                      Structuration de l’opération
                    </p>
                  ...
                  <div class="iconbox">
                    ...
                    <h4>Acquisition</h4>
                   <p>
                      Identification des cibles (concurrent, distributeur, client, fournisseur) en France et à l’international.
                    </p>
                    <p>
                      Recherche de financements de l’opération.
                    </p>
                  </div>
                </div>
                </div>
      ...
      <section class="no-padding">
          <div class="title-warp bg-pricing-h2" >
            <div class="title-block title-on-dark text-center">
              ...
              <p class="sub-title">Comme toujours, les partenaires grandissent avec vous !</p>
              <span class="bottom-title"></span>
            </div>
          </div>
<!--           <div class="container">
