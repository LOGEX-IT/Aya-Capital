  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/projects21-investment-in-energy/construction-of-a-coal-mining-complex-salkadamna')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">ELECTRIFICATION PROJECT OF 250 VILLAGES BY SOLAR PHOTOVOLTAIC SYSTEM</h5>
        <p>ENERGY</p>
        <p class="card-text">
          The energy sector is nowadays at the center of socio-economic issues and the fight against global warming.
        </p>
        <a href="{{URL::to('/en/projects22-investment-in-energy/250-village-electrification-project-by-solar-photovoltaic-system')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">
         CONSTRUCTION OF A 50 MW CONCENTRATION PLANT
        </h5>
        <p>ENERGIE</p>
        <p class="card-text">
        ...
        <a href="{{URL::to('en/projects23-investment-in-energy/construction-dune-powerhouse-concentration-of-50-mw')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/projects24-investment-in-energy/construction-of-a-briquettery-of-coal-mineral-and-biomass')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/projects25-investment-in-energy/hybridization-of-the-diesel-plant-of-diffa')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
            ...
            <div class="col-md-12 text-center mt-4">
              <a href="{{URL::to('/en/invest2/2')}}" class="ot-btn btn-main-color" ><i class="fa fa-caret-square-o-left" aria-hidden="true"></i></a>
