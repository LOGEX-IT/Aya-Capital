...
<!--           <span>WHAT WE DO</span>
 -->          <h3>NIGER TRANSPORTATION INVESTMENT PROJECTS</h3>
          <!-- <ol class="breadcrumb">
            <li>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">ESTABLISHMENT OF A STORAGE INFRASTRUCTURE NETWORK</h5>
        <p>TRANSPORT</p>
        <p class="card-text">
         Since the liberation policies implemented as part of the structural adjustment of the country's economy in the 1980s; the supply of Niger produces in particular ...
        </p>
        <a href="{{URL::to('/en/transport-investment-projects1/installation-of-a-storage-infrastructure-network')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION OF A LUXURY TRANSPORT COMPANY IN NIAMEY</h5>
        <p>TRANSPORT</p>
        <p class="card-text">
         This project aims to revolutionize passenger transport in Niamey. The objective is to provide modern, safe and comfortable means of transport in order to respond to the strong ...
        </p>
        <a href="{{URL::to('/en/transport-investment-projects2/creation-of-luxury-transport-company-niamey')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card" style="height: 260px;">
      <div class="card-body">
        <h5 class="card-title">
         CREATION OF A PUBLIC TRANSPORT COMPANY IN NIAMEY
        </h5>
        <p>TRANSPORT</p>
        <p class="card-text">
         This project aims to revolutionize public transport in Niamey.
        </p>
        <a href="{{URL::to('/en/transport-investment-projects3/creation-of-a-public-transport-company-niamey')}}" class="btn btn-default"><br></br>READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">ACQUISITION OF PACKAGE AND EQUIPMENT TRANSPORT TRUCKS</h5>
        <p>TRANSPORT</p>
        <p class="card-text">
          This project comes within the framework of the continuation of the policy of diversification of the activities of NIGER POSTE which aims to satisfy the strong demand in the sector of logistics and ...
        </p>
        <a href="{{URL::to('/en/transport-investment-projects4/acquisition-of-parcel-and-material-transport-truck')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
