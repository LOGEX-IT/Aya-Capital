...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION OF A JUTE BAG PRODUCTION UNIT</h5>
        <p>INDUSTRY</p>
        <p class="card-text">
         Niger depends mainly on agricultural products with 70% of national crops and 30% of imports. However, for all its consumption of food products, the jute bags used ...
        </p>
        <a href="{{URL::to('/en/investment-industry-projects11/creation-of-a-jute-bag-production-unit')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">STRENGTHENING THE DAIRY PRODUCTS DISTRIBUTION CIRCUIT</h5>
        <p>AGRICULTURE, INDUSTRY
        </p>
        <p class="card-text">
        La laitière du Sahel is a one-person limited liability company, she has more than 10 years of activities in the processing and sale of dairy products.
        </p>
        <a href="{{URL::to('/en/investment-industry-projects12/strengthening-of-the-dairy-products-distribution-circuit')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">
         CONSTRUCTION OF VEHICLE TECHNICAL CONTROL CENTERS
        </h5>
        <p>INDUSTRY</p>
        <p class="card-text">
        ...
        <a href="{{URL::to('/en/investment-industry-projects13/construction-of-vehicle-technical-control-centers')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/investment-industry-projects14/creation-of-an-oilseed-processing-unit')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION OF TWO INDUSTRIAL COMPLEXES IN NIAMEY AND MARADI</h5>
        <p>INDUSTRY</p>
        <p class="card-text">
        ...
        <a href="{{URL::to('/en/investment-industry-projects15/creation-of-two-industrial-complexes-niamey-and-maradi')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">REDYNAMIZATION OF THE NIGER RICE COMPANY'S DISTRIBUTION CIRCUIT</h5>
        <p>INDUSTRY</p>
        <p class="card-text">
        ...
        <a href="{{URL::to('/en/investment-industry-projects16/revitalization-of-the-distribution-circuit-of-the-Niger-rice-company')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/investment-industry-projects17/rehabiltation-of-the-old-industrial-zone-of-niamey')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/investment-industry-projects18/waste-recycling')}}" class="btn btn-default">VOIR PLUS</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="{{URL::to('/en/investment-industry-projects19/creation-of-a-school-of-fashion-and-the-arts-and-an-industrial-complex')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION OF A LIVESTOCK POULTRY FEED PRODUCTION UNIT</p>
        <p class="card-text">
        ...
        <a href="{{URL::to('/en/investment-industry-projects20/creation-of-a-livestock-poultry-feed-production-unit')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
            ...
            <div class="col-md-12 text-center mt-4">
              <a href="{{URL::to('/en/invest1-industry/1')}}" class="ot-btn btn-main-color" ><i style="" class="fa fa-caret-square-o-right" aria-hidden="true"></i></a>
              <a href="{{URL::to('/en/invest3-industry/1')}}" class="ot-btn btn-main-color" ><i style="" class="fa fa-caret-square-o-right" aria-hidden="true"></i></a>
            </div>
