...
<!--           <span>WHAT WE DO</span>
 -->          <h3> NIGER ICT INVESTMENT PROJECTS</h3>
          <!-- <ol class="breadcrumb">
            <li>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION OF AN INNOVATION AND TECHNOLOGY CITY</h5>
        <p>TIC</p>
        <p class="card-text">
          In order to improve the ICT sector in Niger, Niger plans to build a city of innovation and technology in the capital, Niamey. The city will be built on an area ...
        </p>
        <a href="{{URL::to('/en/projects-investment-tic1/creation-of-a-city-of-innovation-and-technology')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CREATION OF A GOVERNMENTAL INTRANET</h5>
        <p>TIC</p>
        <p class="card-text">
         The State of Niger is seeking the support of a private partner to create a government intranet in order to increase the efficiency of public services and promote transparency and good ...
        </p>
        <a href="{{URL::to('/en/projects-investment-tic2/creation-dun-intranet-gouvernemental')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p>TIC</p>
        <p class="card-text">
         This project will allow NIGER POSTE to have a private network in order to connect the entire network instantly.
        </p>
        <a href="{{URL::to('/en/projects-investment-tic3/setting-up-of-a-private-network')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
   <div class="card">
      <div class="card-body">
        <h5 class="card-title">SMART VILLAGES</h5>
        <p>TIC</p>
        <p class="card-text">
        Niger, ranked among the last on the continent in terms of internet access, wants to meet the challenge of ICTs by digitally opening up all its villages. To do this, the state plans to ...
        </p>
        <a href="{{URL::to('/en/projects-investment-tic4/smart-villages')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
  </div>
