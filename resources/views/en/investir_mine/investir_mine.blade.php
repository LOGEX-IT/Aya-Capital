...
<!--           <span>WHAT WE DO</span>
 -->          <h3> NIGER MINE INVESTMENT PROJECTS</h3>
          <!-- <ol class="breadcrumb">
            <li>
...
<div class="row mt-4" >
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CEMENT WORKSHOP IN KAO</h5>
        <p>MINE</p>
        <p class="card-text">
        The objective of the project is the construction of a cement production plant with a capacity of 950,000 tonnes of cement per year in a private state estate of approximately 7,154 hectares in ...
        </p>
        <a href="{{URL::to('/en/investment-in-mine/creation-cement-kao')}}" class="btn btn-default">READ MORE</a>
      </div>
    </div>
  </div>
</div>
