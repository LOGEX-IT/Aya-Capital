        ...
        <ul style="background-color: green;">
          ...
          <li><a href="#">About</a>
            <ul style="background-color: green;">
              ...
              <li><a href="{{URL::to('/en/about-us')}}" ><span>About us</span></a>
                <li><a href="{{URL::to('/en/team')}}" ><span>Our team</span></a>
               <!--  <ul >
              ...
              <li><a href="{{URL::to('/en/contact')}}" ><span>Contact Us</span></a>
              </li>
            </ul>
          </li>
          <li>
            <a href="#">Services </a>
             ...
             <ul style="background-color: green;">
              ...
              <li><a href="#" ><span>Structuring and fundraising</span></a>
                <ul style="background-color: green;">
                  <li><a href="{{URL::to('/en/corporate-finance-projet')}}" ><span>Corporate finance & Finance project</span></a></li>
                  <li><a href="{{URL::to('/en/trade-finance')}}" ><span>Trade finance</span></a></li>
                </ul>
              </li>
              <li><a href="{{URL::to('/en/strategy')}}" ><span>Strategy</span></a>
              </li>
              <li><a href="#" ><span>Disposals and Acquisitions</span></a>
                <ul style="background-color: green;">
                  <li><a href="{{URL::to('/en/acquisition')}}" ><span>Acquisitions</span></a></li>
                  <li><a href="{{URL::to('/en/cession')}}" ><span>Disposals</span></a></li>
                </ul>
              </li>
              <li><a href="{{URL::to('/en/corporate-service')}}" ><span>Corporate services</span></a>
              </li>
            </ul>
          ...
          <ul style="background-color: green;">
              ...
              <li><a href="#" ><span>AYA FUND</span></a>
                <ul style="background-color: green;">
                  <li><a href="{{URL::to('/en/mission')}}" ><span>Mission</span></a></li>
                  <li><a href="{{URL::to('/en/fonctionnement')}}" ><span>Operation</span></a></li>
                  <li><a href="{{URL::to('/en/donors')}}" ><span>Donors</span></a></li>
                  <li><a href="{{URL::to('/en/supported-projects')}}" ><span>Supported projects</span></a></li>
                </ul>
              </li>

              <li><a href="{{URL::to('/en/aya-impact')}}" ><span>Impact</span></a>
              </li>
              <li><a href="{{URL::to('/en/gouvernance')}}" ><span>Governance</span></a>
              </li>
              <li><a href="#" ><span>Become a donor</span></a>
              </li>
              <li><a href="{{URL::to('/en/fund-administration')}}" ><span>Fund administration</span></a>
              </li>
            </ul>
          ...
          <li>
            <a href="{{URL::to('/en/training-and-coaching')}}">Training and Coaching </a>
          </li>

          <li>
            <a href="{{URL::to('/en/contact')}}">Contact </a>
                  ...
                  <ul class="navi-level-1 active-subcolor">
                    ...
                    <li>
                      ...
                      <ul class="navi-level-2">
                        ...
                        <li ><a  href="{{URL::to('/en/strategy')}}">Strategy</a></li>
                        <li ><a  href="#">Disposals and Acquisitions </a>
                          <ul class="navi-level-3">
                            <li><a href="{{URL::to('/en/acquisition')}}" ><span>Acquisitions</span></a></li>
                            <li><a href="{{URL::to('/en/cession')}}" ><span>Disposals</span></a></li>
                          </ul>
                        </li>
                        <li ><a  href="{{URL::to('/en/corporate-service')}}">Corporate services</a></li>
                    ...
                    <li>
                      ...
                      <ul class="navi-level-2">
                        ...
                        <li><a href="{{URL::to('/en/aya-impact')}}">Impact</a>
                        </li>
                        <li><a href="{{URL::to('/en/gouvernance')}}">Governance
                           </a>
                        </li>
                        <li><a href="#">Become a donor</a>
                        </li>
                        <li><a href="{{URL::to('/en/fund-administration')}}" ><span>Fund administration</span></a></li>
                      </ul>
                    </li>
                     <li>
                      <a href="{{URL::to('/investir/1')}}">Invest</a>
                    ...
                    <li class="@yield('contactive')"><a  href="{{URL::to('/en/contact')}}">Contact</a></li>
                  </ul>
                </nav>
