...
<div class="row">
                    <div class="col-md-6 col-sm-6">
                      <div class="item-team">
                        <img src="{{URL::to('public/template/images/ayalogo.png')}}" class="img-responsive" style="height: 300px;" alt="Image">
                       <!--  <div class="body-team">
                          <p style="font-size: 14px; text-align: justify; padding: 15px;"> </p>
                        </div> -->
